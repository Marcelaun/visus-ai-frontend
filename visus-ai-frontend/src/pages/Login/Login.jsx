    ...
    <div className="login-main-container">
      ...
      <div className="login-options-container">
        <form action="#" className="login-form" onSubmit={handleSubmit}>
          <label htmlFor="email" className="login-form-labels">Usuário</label>
            <input type="email" id="email" className="login-input-box" required placeholder='Insira seu e-mail' onChange={(e) => {setEmail(e.target.value)}}/>
            <label htmlFor="password" className="login-form-labels">Senha</label>
            <input type="password" id="password" className="login-input-box" required placeholder='Insira sua senha' onChange={(e) => {setPassword(e.target.value)}}/>
        ...
        <div className="login-create-account-container">
          <h3 className="login-create-account-title">É profissional de saúde e ainda não possui uma conta? Crie aqui!</h3>
